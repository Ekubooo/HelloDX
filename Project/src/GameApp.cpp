...
bool GameApp::InitResource()
{
    ...
    m_pEffectHelper->SetBinaryCacheDirectory(L"Shaders\\Tess\\Cache");


    HR(m_pEffectHelper->CreateShaderFromFile("Tessellation_VS", L"Shaders\\Tess\\Tessellation_VS.hlsl", 
    ...
    HR(m_pEffectHelper->CreateShaderFromFile("Tessellation_Transform_VS", L"Shaders\\Tess\\Tessellation_Transform_VS.hlsl",
        m_pd3dDevice.Get(), "VS", "vs_5_0"));

    HR(m_pEffectHelper->CreateShaderFromFile("Tessellation_Isoline_HS", L"Shaders\\Tess\\Tessellation_Isoline_HS.hlsl",
        m_pd3dDevice.Get(), "HS", "hs_5_0"));
    HR(m_pEffectHelper->CreateShaderFromFile("Tessellation_Triangle_HS", L"Shaders\\Tess\\Tessellation_Triangle_HS.hlsl",
        m_pd3dDevice.Get(), "HS", "hs_5_0"));
    HR(m_pEffectHelper->CreateShaderFromFile("Tessellation_Quad_Integer_HS", L"Shaders\\Tess\\Tessellation_Quad_Integer_HS.hlsl",
        m_pd3dDevice.Get(), "HS", "hs_5_0"));
    HR(m_pEffectHelper->CreateShaderFromFile("Tessellation_Quad_Odd_HS", L"Shaders\\Tess\\Tessellation_Quad_Odd_HS.hlsl",
        m_pd3dDevice.Get(), "HS", "hs_5_0"));
    HR(m_pEffectHelper->CreateShaderFromFile("Tessellation_Quad_Even_HS", L"Shaders\\Tess\\Tessellation_Quad_Even_HS.hlsl",
        m_pd3dDevice.Get(), "HS", "hs_5_0"));
    HR(m_pEffectHelper->CreateShaderFromFile("Tessellation_BezierSurface_HS", L"Shaders\\Tess\\Tessellation_BezierSurface_HS.hlsl",
        m_pd3dDevice.Get(), "HS", "hs_5_0"));

    HR(m_pEffectHelper->CreateShaderFromFile("Tessellation_BezierCurve_DS", L"Shaders\\Tess\\Tessellation_BezierCurve_DS.hlsl",
        m_pd3dDevice.Get(), "DS", "ds_5_0"));
    HR(m_pEffectHelper->CreateShaderFromFile("Tessellation_Triangle_DS", L"Shaders\\Tess\\Tessellation_Triangle_DS.hlsl",
        m_pd3dDevice.Get(), "DS", "ds_5_0"));
    HR(m_pEffectHelper->CreateShaderFromFile("Tessellation_Quad_DS", L"Shaders\\Tess\\Tessellation_Quad_DS.hlsl",
        m_pd3dDevice.Get(), "DS", "ds_5_0"));
    HR(m_pEffectHelper->CreateShaderFromFile("Tessellation_BezierSurface_DS", L"Shaders\\Tess\\Tessellation_BezierSurface_DS.hlsl",
        m_pd3dDevice.Get(), "DS", "ds_5_0"));

    HR(m_pEffectHelper->CreateShaderFromFile("Tessellation_Point2Square_GS", L"Shaders\\Tess\\Tessellation_Point2Square_GS.hlsl",
        m_pd3dDevice.Get(), "GS", "gs_5_0"));
    
    HR(m_pEffectHelper->CreateShaderFromFile("Tessellation_PS", L"Shaders\\Tess\\Tessellation_PS.hlsl",
