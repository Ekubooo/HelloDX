...
// later include than Effects.h and d3dUtil.h
...
//
// BasicEffect::Impl need to be defin befor BasicEffect
//
...
public:
    ...
    // Structure corresponding to HLSL 
    // 16 byte alignment
...
public:
    // have be explicitly specified
    Impl() : m_IsDirty() {}
    ~Impl() = default;

public:
    // 16 byte alignment on top
