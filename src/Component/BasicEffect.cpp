...
bool BasicEffect::InitAll(ID3D11Device * device)
{
    ...
    // 流输出分裂三角形
    //
    HR(CreateShaderFromFile(L"HLSL\\Fractal\\TriangleSO_VS.cso", L"HLSL\\Fractal\\TriangleSO_VS.hlsl", "VS", "vs_5_0", blob.ReleaseAndGetAddressOf()));
    ...
    HR(CreateShaderFromFile(L"HLSL\\Fractal\\TriangleSO_GS.cso", L"HLSL\\Fractal\\TriangleSO_GS.hlsl", "GS", "gs_5_0", blob.ReleaseAndGetAddressOf()));
    ...
    // 绘制分形三角形
    //
    HR(CreateShaderFromFile(L"HLSL\\Fractal\\Triangle_VS.cso", L"HLSL\\Fractal\\Triangle_VS.hlsl", "VS", "vs_5_0", blob.ReleaseAndGetAddressOf()));
    HR(device->CreateVertexShader(blob->GetBufferPointer(), blob->GetBufferSize(), nullptr, pImpl->m_pTriangleVS.GetAddressOf()));
    HR(CreateShaderFromFile(L"HLSL\\Fractal\\Triangle_PS.cso", L"HLSL\\Fractal\\Triangle_PS.hlsl", "PS", "ps_5_0", blob.ReleaseAndGetAddressOf()));
    ...
    // 流输出分形球体
    //
    HR(CreateShaderFromFile(L"HLSL\\Fractal\\SphereSO_VS.cso", L"HLSL\\Fractal\\SphereSO_VS.hlsl", "VS", "vs_5_0", blob.ReleaseAndGetAddressOf()));
    ...
    HR(CreateShaderFromFile(L"HLSL\\Fractal\\SphereSO_GS.cso", L"HLSL\\Fractal\\SphereSO_GS.hlsl", "GS", "gs_5_0", blob.ReleaseAndGetAddressOf()));
    ...
    // 绘制球体
    //
    HR(CreateShaderFromFile(L"HLSL\\Fractal\\Sphere_VS.cso", L"HLSL\\Fractal\\Sphere_VS.hlsl", "VS", "vs_5_0", blob.ReleaseAndGetAddressOf()));
    HR(device->CreateVertexShader(blob->GetBufferPointer(), blob->GetBufferSize(), nullptr, pImpl->m_pSphereVS.GetAddressOf()));
    HR(CreateShaderFromFile(L"HLSL\\Fractal\\Sphere_PS.cso", L"HLSL\\Fractal\\Sphere_PS.hlsl", "PS", "ps_5_0", blob.ReleaseAndGetAddressOf()));
    ...
    // 流输出分形雪花
    //
    HR(CreateShaderFromFile(L"HLSL\\Fractal\\SnowSO_VS.cso", L"HLSL\\Fractal\\SnowSO_VS.hlsl", "VS", "vs_5_0", blob.ReleaseAndGetAddressOf()));
    HR(device->CreateVertexShader(blob->GetBufferPointer(), blob->GetBufferSize(), nullptr, pImpl->m_pSnowSOVS.GetAddressOf()));
    HR(CreateShaderFromFile(L"HLSL\\Fractal\\SnowSO_GS.cso", L"HLSL\\Fractal\\SnowSO_GS.hlsl", "GS", "gs_5_0", blob.ReleaseAndGetAddressOf()));
    HR(device->CreateGeometryShaderWithStreamOutput(blob->GetBufferPointer(), blob->GetBufferSize(), posColorLayout, ARRAYSIZE(posColorLayout),
    ...
    // 绘制雪花
    //
    HR(CreateShaderFromFile(L"HLSL\\Fractal\\Snow_VS.cso", L"HLSL\\Fractal\\Snow_VS.hlsl", "VS", "vs_5_0", blob.ReleaseAndGetAddressOf()));
    HR(device->CreateVertexShader(blob->GetBufferPointer(), blob->GetBufferSize(), nullptr, pImpl->m_pSnowVS.GetAddressOf()));
    HR(CreateShaderFromFile(L"HLSL\\Fractal\\Snow_PS.cso", L"HLSL\\Fractal\\Snow_PS.hlsl", "PS", "ps_5_0", blob.ReleaseAndGetAddressOf()));
    ...
    // 绘制法向量
    //
    HR(CreateShaderFromFile(L"HLSL\\Fractal\\Normal_VS.cso", L"HLSL\\Fractal\\Normal_VS.hlsl", "VS", "vs_5_0", blob.ReleaseAndGetAddressOf()));
    HR(device->CreateVertexShader(blob->GetBufferPointer(), blob->GetBufferSize(), nullptr, pImpl->m_pNormalVS.GetAddressOf()));
    HR(CreateShaderFromFile(L"HLSL\\Fractal\\Normal_GS.cso", L"HLSL\\Fractal\\Normal_GS.hlsl", "GS", "gs_5_0", blob.ReleaseAndGetAddressOf()));
    HR(device->CreateGeometryShader(blob->GetBufferPointer(), blob->GetBufferSize(), nullptr, pImpl->m_pNormalGS.GetAddressOf()));
    HR(CreateShaderFromFile(L"HLSL\\Fractal\\Normal_PS.cso", L"HLSL\\Fractal\\Normal_PS.hlsl", "PS", "ps_5_0", blob.ReleaseAndGetAddressOf()));
